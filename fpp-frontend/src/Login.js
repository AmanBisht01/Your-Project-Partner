    ...
    <div className="login">
      <div className="login_body">
        <div className="choice">
          <Link to="/signup">
            <p
              className={`${choice === "login" && "choice_other"} choice_text`}
            >
              SIGN UP
            </p>
          </Link>
          ...
          <Link to="/login">
            <p
              className={`${choice === "signup" && "choice_other"} choice_text`}
            >
              LOGIN
            </p>
          </Link>
        ...
        <div className="login_details">
          <form action="">
            ...
            {choice === "login" ? (
              <button onClick={user_login} className="login_btn">
                Login
              </button>
            ) : (
              <button onClick={user_signup} className="login_btn">
                Sign Up
              </button>
            )}
          </form>
